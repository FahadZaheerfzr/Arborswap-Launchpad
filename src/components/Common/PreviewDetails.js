...
export default function   PreviewDetails({ name, value, icon, verified, tokenSymbol }) {
  return (
    <div className="py-5 flex gap-x-5 justify-between border-b border-dashed border-dim-text border-opacity-30">
      ...
      <div className="flex items-center break-all">
        ...
        <span className="font-gilroy  text-sm font-bold text-dark-text dark:text-light-text">{value} {tokenSymbol && tokenSymbol}</span>
